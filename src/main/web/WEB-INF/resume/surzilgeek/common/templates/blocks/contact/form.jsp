...
<div class="contact">
    <div class="contact-info">
        <div class="title">
            ...
            <h3><s:message htmlEscape="false" code="contact.message.title" text="Leave me a message" /></h3>
        </div>                            
        <p><s:message htmlEscape="false" code="contact.message.description" text="To get in touch, please fill this form." /></p>
    </div>
	...
	<div class="alert alert-warning fade in alert-dismissable" role="alert">
	    ...
	    <p><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> <s:message htmlEscape="false" code="contact.mandatory" text="All fields are mandatory." /></p>
	</div>   
                   
    <s:message htmlEscape="false" var="messageError" code="contact.message.error" text="Error!" />
	<div id="form-errors" class="alert alert-danger fade in alert-dismissable hidden" role="alert" aria-hidden="true">
	    ...
	    <p id="name-NotEmpty" class="hidden" aria-hidden="true"><strong>${messageError}</strong> <s:message htmlEscape="false" code="contact.message.empty.name" text="Name must be fill !" /></p>
	    <p id="email-NotEmpty" class="hidden" aria-hidden="true"><strong>${messageError}</strong> <s:message htmlEscape="false" code="contact.message.empty.email" text="Email must be fill !" /></p>
	    <p id="subject-NotEmpty" class="hidden" aria-hidden="true"><strong>${messageError}</strong> <s:message htmlEscape="false" code="contact.message.empty.subject" text="Subject must be fill !" /></p>
		<p id="message-NotEmpty" class="hidden" aria-hidden="true"><strong>${messageError}</strong> <s:message htmlEscape="false" code="contact.message.empty.message" text="Message must be fill !" /></p>
	</div>
	
	<div id="form-confirm" class="alert alert-success fade in alert-dismissable hidden" role="alert" aria-hidden="true">
	    <a class="close" aria-label="close" title="close">×</a>
	    <p><strong><s:message htmlEscape="false" code="contact.message.success" text="Success!" /></strong> <s:message htmlEscape="false" code="contact.message.success" text="Thanks you !" /></p>
	</div>        
	<c:choose>
		<c:when test="${blockPreview}">
			<form id="contact-form" class="contact-form" name="contact-form" method="post" modelAttribute="contact">
			    <div class="row">
			        <div class="col-sm-6">
			            <div class="form-group">
			            	<s:message htmlEscape="false" var="contactName" code="contact.name" text="Full name" />
			        ...
			        <div class="col-sm-6">
			            <div class="form-group">
			            	<s:message htmlEscape="false" var="contactEmail" code="contact.email" text="Your email id" />
			        ...
			        <div class="col-sm-12">
			            <div class="form-group">
			            	<s:message htmlEscape="false" var="contactSubject" code="contact.subject" text="Subject" />
			        ...
			        <div class="col-sm-12">
			            <div class="form-group">
			            	<s:message htmlEscape="false" var="contactMessage" code="contact.message" text="Your message" />
			    ...
			    <div class="form-group pull-right">
			    	<s:message htmlEscape="false" var="contactSubmit" code="contact.submit" text="Submit" />
